    ...
    <div className="flex flex-col md:flex-row gap-8 p-6 max-w-6xl mx-auto bg-white rounded-xl shadow-sm">
      ...
      <div className="w-full md:w-1/2 flex flex-col gap-6">
        ...
        <div className="text-gray-700 text-base leading-relaxed">
          ...
          {product.description?.length > 160 && (
            <button
              ...
              className="text-[#003087] ml-2 font-medium hover:underline"
            >
        ...
        <div className="flex items-center gap-4 text-sm">
          ...
          <button className="text-[#003087] hover:underline">✉ Enquiry</button>
        </div>
        ...
        <div className="flex flex-col sm:flex-row items-start sm:items-center gap-4 mt-6 w-full">
          ...
          <button
            ...
            className="w-full sm:w-[250px] py-3 px-6 text-sm font-bold tracking-wide text-white bg-[#003087] rounded-md hover:bg-[#4A6BFF] transition-all"
          >
            ADD TO CART
          </button>
        </div>
